...
## 2026-03-13 - Project Documentation Organization
**Status:** ✅ Completed
**Summary:**
Cleaned up the root directory and organized project documentation into dedicated folders within docs/.

**Changes:**
- **Marketing:** Created docs/marketing/ and moved MARKETING-COPY.md, SEO-CONTENT-STRATEGY.md, SOCIAL-MEDIA-PLAYBOOK.md.
- **Archive:** Created docs/archive/ and moved implementation-log.md.
- **Bugs:** Created docs/bugs/ and moved BUG-REPORT.md, BUG-FIX-REPORT.md.
- **Strategy:** Created docs/strategy/ and moved EXECUTION-PLAN.md, MASTER-STRATEGY.md, SUBTLE-STRATEGIES.md, FIN-EYE-ANALYSIS.md, rainstormıng-fate.md.
- **User Stories:** Created docs/user_stories/ and moved user-stories.md, prdv3.md.

- **Scripts:** Created scripts/ folder and moved diag_db.py, ix_db.py, list_tables.py, eset_db.py, 	est_db_conn.py.
- **Misc:** Archived 	odo.md.
- **User Stories:** Also moved user-stories-v2.md to docs/user_stories/.
