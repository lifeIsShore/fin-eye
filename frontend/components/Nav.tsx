...
import {
    ...
    TrendingDown, TrendingUp, Calendar, PieChart, Landmark, BarChart,
...
const SIDEBAR_SECTIONS: NavSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { href: "/portfolio/bond-ladder", label: "Bond Ladder", icon: <TrendingUp className="h-4 w-4" />, badge: "NEW" as NavBadge },
